...
<a href="/About">
	...
	<div class="main_page">
		...
		Platforms: Windows(Soon), Linux(Soon)
		</div>
		<div class="sub_text">
		<img src="/files/tg_logo.ico" alt="Tone Generator Emblem">
		<div class="sub_text">
		Summative project for Grade 11 computer science. Originally written in ActionScript 3.0 for Flash, it has been ported to a more "Alive" platform as Flash is on the way out.
		</div>
		<a href="/Projects/ToneGen/ToneGen.exe">Download for Windows (Soon)</a>
		<a href="/Projects/ToneGen">Download for Linux (Soon)</a>
		</div>
