...
<a href="/About">
	...
	<div class="main_page">
		...
		Platforms: Windows, Linux(Soon)
		</div>
		<div class="sub_text">
		<img src="/files/tm_logo.ico" alt="Tone Matricks Emblem">
		<div class="sub_text">
		A side-project started in July 2016. Built on .NET v2+ console and text-based, generating sound through system BEEP() function.
		<div>
			<p align="middle">
			<a href="/Projects/TM/1-00/ToneMatricks-1.0.0.zip">TM 1.0.0 (With source code!)</a>
			</p>
		</div>
		<div>
			<p align="middle">
			<a href="/Projects/TM/1-30/ToneMatricks-1.3.0.exe">TM 1.3.0</a>
			</p>
		</div>
		<div>
			<p align="middle">
			<a href="/Projects/TM/2-00/ToneMatricks-2.0.0.zip">TM 2.0.0</a>
			</p>
		</div>
		<div>
			<p align="middle">
			<a href="/Projects/TM/2-01/ToneMatricks-2.0.1.zip">TM 2.0.1</a>
			</p>
		</div>
		</div>
	</div>
